...
void APrize_MangleMask_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function Prize_MangleMask.Prize_MangleMask_C.UserConstructionScript");

	APrize_MangleMask_C_UserConstructionScript_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Prize_MangleMask.Prize_MangleMask_C.ReceiveBeginPlay");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Prize_MangleMask.Prize_MangleMask_C.RemoveMask");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Prize_MangleMask.Prize_MangleMask_C.BndEvt__Sphere_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Prize_MangleMask.Prize_MangleMask_C.BndEvt__Sphere_K2Node_ComponentBoundEvent_5_ComponentEndOverlapSignature__DelegateSignature");
...
void APrize_MangleMask_C::OnVRReleased(class ASWGVRCharacter** Grabber, EVRHandType* Hand, struct FVector* ReleaseVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function Prize_MangleMask.Prize_MangleMask_C.OnVRReleased");
...
void APrize_MangleMask_C::OnVRGrabbed(class ASWGVRCharacter** Grabber, EVRHandType* Hand)
{
	static auto fn = UObject::FindObject<UFunction>("Function Prize_MangleMask.Prize_MangleMask_C.OnVRGrabbed");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Prize_MangleMask.Prize_MangleMask_C.ExecuteUbergraph_Prize_MangleMask");
